...
- :telescope: I use ReactJS, NextJS, TypeScript, SCSS, Prisma, in building my web applications.
 
- :seedling: Building Mobile Apps with React Native.
 
- :seedling: Building REST APIs with NodeJS, C# (ASP.NET).
